...
@section('content')
<div class="mb-6">
    <a href="{{ route('admin.categories.index') }}" class="text-gray-500 hover:text-gray-700 flex items-center gap-2 w-max">
        <i data-lucide="arrow-left" class="w-4 h-4"></i> Kembali ke Daftar Kategori
    </a>
</div>

<div class="admin-card max-w-3xl">
    <h2 class="text-xl font-bold mb-6">Tambah Kategori Baru</h2>
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST">
        ...
        <div class="flex justify-end gap-3 mt-8">
            <a href="{{ route('admin.categories.index') }}" class="btn-admin bg-gray-200 hover:bg-gray-300 text-gray-800">Batal</a>
            <button type="submit" class="btn-admin btn-primary">
                <i data-lucide="save" class="w-4 h-4 mr-2 inline-block"></i> Simpan
            </button>
        </div>
    </form>
</div>
